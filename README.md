...
This repository contains a collection of 12dPL macros used for design automation, validation, and productivity workflows within 12d Model.

Each macro is self-contained in its own folder and follows a consistent structure.
